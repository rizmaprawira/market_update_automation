"""Download financial reports for PT Asuransi Jiwa Teguh Pelita Pelindung."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_teguh_pelita_pelindung")
SOURCE_URL = "https://equiralife.co.id/id/report/financial"
COMPANY_ID = "teguh_pelita_pelindung"
