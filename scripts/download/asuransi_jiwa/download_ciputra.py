"""Download financial reports for PT Asuransi Ciputra Indonesia."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_ciputra")
...
def main():
    ...
    parser.add_argument("--use-browser", action="store_true", help="Recommended: Ciputra uses dynamic content")
    ...
    if not args.use_browser:
        LOGGER.warning("Ciputra uses dynamic content - recommend --use-browser flag")
