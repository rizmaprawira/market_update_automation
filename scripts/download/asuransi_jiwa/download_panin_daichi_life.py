"""Download financial reports for PT Panin Dai-Chi Life."""
import argparse
import logging
import sys
...
from _downloader_base import (
    ...
    fetch_html_static, fetch_html_browser, current_timestamp, try_common_pdf_urls
)

LOGGER = logging.getLogger("download_panin_daichi_life")
SOURCE_URL = "https://www.panindai-ichilife.co.id/id/laporan-keuangan"
COMPANY_ID = "panin_daichi_life"
