"""Download financial reports for PT Asuransi BRI Life."""
import argparse
import logging
import sys
...
LOGGER = logging.getLogger("download_brilife")
...
def main():
    ...
    parser.add_argument("--use-browser", action="store_true", help="Recommended: BRI Life requires JS rendering")
    ...
    if not args.use_browser:
        LOGGER.warning("BRI Life uses JavaScript - recommend --use-browser flag")
