"""Convert pt_zurich_topas_life monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_zurich_topas_life.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_zurich_topas_life/pt_zurich_topas_life_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_zurich_topas_life/pt_zurich_topas_life_{period}.xlsx
"""
