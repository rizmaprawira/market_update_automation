...
Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_aia_financial.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_aia_financial/pt_aia_financial_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_aia_financial/pt_aia_financial_{period}.xlsx
"""
