"""Convert pt_prudential_life_assurance monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_prudential_life_assurance.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_prudential_life_assurance/pt_prudential_life_assurance_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_prudential_life_assurance/pt_prudential_life_assurance_{period}.xlsx
"""
