"""Convert pt_asuransi_jiwa_nasional monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_asuransi_jiwa_nasional.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_asuransi_jiwa_nasional/pt_asuransi_jiwa_nasional_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_asuransi_jiwa_nasional/pt_asuransi_jiwa_nasional_{period}.xlsx
"""
