"""Convert pt_asuransi_simas_jiwa monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_asuransi_simas_jiwa.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_asuransi_simas_jiwa/pt_asuransi_simas_jiwa_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_asuransi_simas_jiwa/pt_asuransi_simas_jiwa_{period}.xlsx
"""
