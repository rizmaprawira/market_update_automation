"""Convert pt_asuransi_jiwa_teguh_pelita_pelindung monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_asuransi_jiwa_teguh_pelita_pelindung.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_asuransi_jiwa_teguh_pelita_pelindung/pt_asuransi_jiwa_teguh_pelita_pelindung_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_asuransi_jiwa_teguh_pelita_pelindung/pt_asuransi_jiwa_teguh_pelita_pelindung_{period}.xlsx
"""
