...
Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_ajb_bumiputera_1912/pt_ajb_bumiputera_1912_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_ajb_bumiputera_1912/pt_ajb_bumiputera_1912_{period}.xlsx
"""
