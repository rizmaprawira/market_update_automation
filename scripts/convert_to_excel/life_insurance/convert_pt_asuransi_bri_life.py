...
Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_asuransi_bri_life.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_asuransi_bri_life/pt_asuransi_bri_life_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_asuransi_bri_life/pt_asuransi_bri_life_{period}.xlsx
"""
