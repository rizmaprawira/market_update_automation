"""Convert pt_chubb_life_insurance monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/life_insurance/convert_pt_chubb_life_insurance.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_jiwa/pt_chubb_life_insurance/pt_chubb_life_insurance_{period}.pdf
Output: data/{period}/converted_excel/asuransi_jiwa/pt_chubb_life_insurance/pt_chubb_life_insurance_{period}.xlsx
"""
