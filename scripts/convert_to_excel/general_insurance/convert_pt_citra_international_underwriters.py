"""Convert Pt Citra International Underwriters monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_citra_international_underwriters.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_citra_international_underwriters/pt_citra_international_underwriters_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_citra_international_underwriters/pt_citra_international_underwriters_{period}.xlsx
"""
