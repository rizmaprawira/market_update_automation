"""Convert Pt Asuransi Multi Artha Guna Tbk monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_multi_artha_guna_tbk.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_multi_artha_guna_tbk/pt_asuransi_multi_artha_guna_tbk_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_multi_artha_guna_tbk/pt_asuransi_multi_artha_guna_tbk_{period}.xlsx
"""
