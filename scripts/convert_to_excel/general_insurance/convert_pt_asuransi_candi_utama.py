"""Convert Pt Asuransi Candi Utama monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_candi_utama.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_candi_utama/pt_asuransi_candi_utama_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_candi_utama/pt_asuransi_candi_utama_{period}.xlsx
"""
