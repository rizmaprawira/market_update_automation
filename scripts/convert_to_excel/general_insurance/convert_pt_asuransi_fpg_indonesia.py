"""Convert Pt Asuransi Fpg Indonesia monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_fpg_indonesia.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_fpg_indonesia/pt_asuransi_fpg_indonesia_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_fpg_indonesia/pt_asuransi_fpg_indonesia_{period}.xlsx
"""
