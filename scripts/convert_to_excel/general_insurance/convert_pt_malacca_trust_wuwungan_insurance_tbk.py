"""Convert Pt Malacca Trust Wuwungan Insurance Tbk monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_malacca_trust_wuwungan_insurance_tbk.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_malacca_trust_wuwungan_insurance_tbk/pt_malacca_trust_wuwungan_insurance_tbk_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_malacca_trust_wuwungan_insurance_tbk/pt_malacca_trust_wuwungan_insurance_tbk_{period}.xlsx
"""
