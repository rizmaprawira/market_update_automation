"""Convert Pt Asuransi Astra Buana monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_astra_buana.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_astra_buana/pt_asuransi_astra_buana_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_astra_buana/pt_asuransi_astra_buana_{period}.xlsx
"""
