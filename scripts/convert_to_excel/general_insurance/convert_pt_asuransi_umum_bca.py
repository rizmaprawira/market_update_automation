"""Convert Pt Asuransi Umum Bca monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_umum_bca.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_umum_bca/pt_asuransi_umum_bca_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_umum_bca/pt_asuransi_umum_bca_{period}.xlsx
"""
