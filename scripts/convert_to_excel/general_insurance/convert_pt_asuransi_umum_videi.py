"""Convert Pt Asuransi Umum Videi monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_umum_videi.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_umum_videi/pt_asuransi_umum_videi_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_umum_videi/pt_asuransi_umum_videi_{period}.xlsx
"""
