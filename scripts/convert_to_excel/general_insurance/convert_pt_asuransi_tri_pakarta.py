"""Convert Pt Asuransi Tri Pakarta monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_tri_pakarta.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_tri_pakarta/pt_asuransi_tri_pakarta_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_tri_pakarta/pt_asuransi_tri_pakarta_{period}.xlsx
"""
