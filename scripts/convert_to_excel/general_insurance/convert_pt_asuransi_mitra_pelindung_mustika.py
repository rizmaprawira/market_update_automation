"""Convert Pt Asuransi Mitra Pelindung Mustika monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_mitra_pelindung_mustika.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_mitra_pelindung_mustika/pt_asuransi_mitra_pelindung_mustika_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_mitra_pelindung_mustika/pt_asuransi_mitra_pelindung_mustika_{period}.xlsx
"""
