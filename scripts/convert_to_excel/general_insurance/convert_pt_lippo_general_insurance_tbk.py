"""Convert Pt Lippo General Insurance Tbk monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_lippo_general_insurance_tbk.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_lippo_general_insurance_tbk/pt_lippo_general_insurance_tbk_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_lippo_general_insurance_tbk/pt_lippo_general_insurance_tbk_{period}.xlsx
"""
