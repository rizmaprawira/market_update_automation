"""Convert Pt Asuransi Sahabat Artha Proteksi monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_sahabat_artha_proteksi.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_sahabat_artha_proteksi/pt_asuransi_sahabat_artha_proteksi_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_sahabat_artha_proteksi/pt_asuransi_sahabat_artha_proteksi_{period}.xlsx
"""
