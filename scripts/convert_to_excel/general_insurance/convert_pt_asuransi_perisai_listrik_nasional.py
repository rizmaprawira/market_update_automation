"""Convert Pt Asuransi Perisai Listrik Nasional monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_asuransi_perisai_listrik_nasional.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_asuransi_perisai_listrik_nasional/pt_asuransi_perisai_listrik_nasional_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_asuransi_perisai_listrik_nasional/pt_asuransi_perisai_listrik_nasional_{period}.xlsx
"""
