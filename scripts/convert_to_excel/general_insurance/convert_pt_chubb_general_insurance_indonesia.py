"""Convert Pt Chubb General Insurance Indonesia monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/general_insurance/convert_pt_chubb_general_insurance_indonesia.py [--period 2026-03]

Input:  data/{period}/raw_pdf/asuransi_umum/pt_chubb_general_insurance_indonesia/pt_chubb_general_insurance_indonesia_{period}.pdf
Output: data/{period}/converted_excel/asuransi_umum/pt_chubb_general_insurance_indonesia/pt_chubb_general_insurance_indonesia_{period}.xlsx
"""
