...
Marein uses a bilingual (Indonesian/English) layout. English columns (F, K, P)
receive italic styling and a distinct background fill.

Usage:
    python scripts/convert_to_excel/reinsurance/convert_marein.py [--period 2026-03]

Input:  data/{period}/raw_pdf/reasuransi/marein/marein_{period_u}.pdf
Output: data/{period}/converted_excel/reasuransi/marein/marein_{period}.xlsx
"""
