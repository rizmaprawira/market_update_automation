"""Convert PT Tugu Reasuransi Indonesia (TUGURE) monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/reinsurance/convert_tugure.py [--period 2026-03]

Input:  data/{period}/raw_pdf/reasuransi/tugure/tugure_{period}.pdf
Output: data/{period}/converted_excel/reasuransi/tugure/tugure_{period}.xlsx
"""
