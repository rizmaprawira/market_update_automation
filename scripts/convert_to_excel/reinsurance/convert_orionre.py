"""Convert PT Orion Reasuransi Indonesia (ORIONRE) monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/reinsurance/convert_orionre.py [--period 2026-03]

Input:  data/{period}/raw_pdf/reasuransi/orionre/orionre_{period}.pdf
Output: data/{period}/converted_excel/reasuransi/orionre/orionre_{period}.xlsx
"""
