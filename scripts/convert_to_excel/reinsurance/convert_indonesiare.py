"""Convert PT Reasuransi Indonesia Utama / IndoRe monthly PDF to Excel.

Usage:
    python scripts/convert_to_excel/reinsurance/convert_indonesiare.py [--period 2026-03]

Input:  data/{period}/raw_pdf/reasuransi/indonesiare/indonesiare_{period}.pdf
Output: data/{period}/converted_excel/reasuransi/indonesiare/indonesiare_{period}.xlsx
"""
